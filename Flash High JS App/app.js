...
function renderCharts() {
  ...
  if (ctx1) {
    state.charts['chart-weekly'] = new Chart(ctx1.getContext('2d'), {
      ...
      data: {
        ...
        datasets: [{
          data: weekKeys.map(k => weekCounts[k]),
  ...
  if (ctx2) {
    state.charts['chart-states'] = new Chart(ctx2.getContext('2d'), {
      type: 'doughnut',
      data: {
        labels: slabels.map(l => l.toUpperCase()),
        datasets: [{
          data: slabels.map(k => sc[k]),
      ...
      options: {
        ...
        plugins: {
          legend: { position: 'bottom', labels: { color: '#9898aa', font: { size: 10 }, padding: 12, boxWidth: 10 } },
  ...
  if (ctx3) {
    state.charts['chart-hours'] = new Chart(ctx3.getContext('2d'), {
      ...
      data: {
        ...
        datasets: [{
          data: hVals, backgroundColor: 'rgba(124,58,237,0.7)',
